...
// faudra penser a cree le bouton nv note
/* let button = document.querySelector("#button");
button.addEventListener("click",) */
notesArray.unshift(checkliste1=new ChecklistNote("exercice1",new Date(),"rouge","",[{"fait":true},{"pas fait":false}]));
/* notesArray.unshift(checkliste2=new ChecklistNote("exercice2",new Date(),"rouge","",[{"fait":true},{"pas fait":false}]));
 */
/* notesArray.unshift(note1=new TextNote("text",new Date,"rouge",undefined,[])); */
